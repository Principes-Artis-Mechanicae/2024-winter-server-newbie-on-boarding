...
# ex) git clone https://github.com/scv1702/2024-winter-server-pre-onboarding.git
```
2. clone한 디렉토리로 이동한다.
```bash
cd {저장소_아이디}
# ex) cd 2024-winter-server-pre-onboarding
```
...
- 예를 들어, 과제를 진행한 `scv1702/2024-winter-server-pre-onboarding scv1702` 브랜치에서 `Principes-Artis-Mechanicae/2024-winter-server-pre-onboarding scv1702` 브랜치로 Pull Request를 보낸다.
